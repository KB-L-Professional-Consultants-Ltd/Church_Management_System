  ...
  return (
    <div className="w-full">
      <div className="overflow-hidden rounded-xl border border-outline-variant/30 bg-surface-container-lowest p-8 shadow-[0_4px_20px_rgba(0,27,61,0.04)]">
        ...
        {error && (
          <div className="mb-6 rounded-lg border border-error bg-error-container p-3">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <div className="relative">
              <span
                className="material-symbols-outlined absolute top-1/2 left-4 -translate-y-1/2 text-outline"
                style={{ fontSize: "20px" }}
              >
                person
              </span>
